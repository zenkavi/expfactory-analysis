# this file includes a previous version of ddm_utils that used HDDM's "depends_on"
# to calculate condition differences rather than regression
...
def fit_HDDM(df, response_col = 'correct', condition = None, fixed= ['t','a'], 
             estimate_task_vars = True, outfile = None, 
             samples=40000,
             burn=4000,
             thin=2):
